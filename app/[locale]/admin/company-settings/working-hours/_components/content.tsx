...
import BreakRules from "./break-rules";
import OvertimeRules from "./overtime-rules";
  ...
  return (
    <FormProvider {...form}>
      <form className="relative flex flex-col gap-8 h-full pb-28">
        <PageTitleAdmin
          title="Working Hours"
          description="Define your organization’s default working schedule, break rules, and overtime calculation."
        />
        <WorkSchedule />
